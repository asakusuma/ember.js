...
moduleFor('Helpers test: {{input}}', class extends InputRenderingTest {
  ...
  ['@test should insert a text field into DOM']() {
  ...
  ['@test input value is updated when setting value property of view']() {
    this.render(defaultTemplate, defaultContext);
  ...
  ['@test input placeholder is updated when setting placeholder property of view']() {
    this.render(defaultTemplate, defaultContext);
  ...
  ['@test input name is updated when setting name property of view']() {
    this.render(defaultTemplate, defaultContext);
  ...
  ['@test input maxlength is updated when setting maxlength property of view']() {
    this.render(defaultTemplate, defaultContext);
  ...
  ['@test input size is updated when setting size property of view']() {
    this.render(defaultTemplate, defaultContext);
  ...
  ['@test input tabindex is updated when setting tabindex property of view']() {
    this.render(defaultTemplate, defaultContext);
  ...
  ['@test should insert a text field into DOM for static value']() {
  ...
  ['@test should become disabled if the disabled attribute is true for static value']() {
    this.render(staticTemplate, {});
    ok(this.$('input').is(':disabled'), 'The text field is disabled');
  ...
  ['@test input value is updated when setting value property of view for static value']() {
    this.render(staticTemplate, {});
    equal(this.$('input').val(), 'hello', 'renders text field with value');
  ...
  ['@test input placeholder is updated when setting placeholder property of view for static value']() {
    this.render(staticTemplate, {});
    equal(this.$('input').attr('placeholder'), 'Enter some text', 'renders text field with placeholder');
  ...
  ['@test input name is updated when setting name property of view for static value']() {
    this.render(staticTemplate, {});
    equal(this.$('input').attr('name'), 'some-name', 'renders text field with name');
  ...
  ['@test input maxlength is updated when setting maxlength property of view for static value']() {
    this.render(staticTemplate, {});
    equal(this.$('input').attr('maxlength'), '30', 'renders text field with maxlength');
  ...
  ['@test input size is updated when setting size property of view for static value']() {
    this.render(staticTemplate, {});
    equal(this.$('input').attr('size'), '30', 'renders text field with size');
  ...
  ['@test input tabindex is updated when setting tabindex property of view for static value']() {
    this.render(staticTemplate, {});
    equal(this.$('input').attr('tabindex'), '5', 'renders text field with the tabindex');
  ...
  ['@handlebars specifying `on="someevent" action="foo"` triggers the action']() {
    expect(2);

    expectDeprecation(() => {
      this.registerComponent('my-action-component', {
        ComponentClass: Component.extend({
          sendAction(actionName, value, sender) {
  ...
  ['@test should insert a text field into DOM with dynamic type']() {
  ...
  ['@test should change if the type changes']() {
    this.render('{{input type=someProperty}}', {
      someProperty: 'password'
    });
    equal(this.$('input').attr('type'), 'password', 'a bound property can be used to determine type.');
  ...
  ['@test should begin disabled if the disabled attribute is true']() {
    this.render(checkboxTemplate, checkboxContext);
  ...
  ['@test should support the tabindex property']() {
    this.render(checkboxTemplate, checkboxContext);
  ...
  ['@test checkbox checked property is updated']() {
    this.render(checkboxTemplate, checkboxContext);
  ...
  ['@test It asserts the presence of checked=']() {
    expectAssertion(() => {
  ...
  ['@test should append a checkbox with bound type']() {
  ...
  // view was used.
  ['@test checkbox checked property is updated with bound type']() {
    this.render('{{input type=inputType checked=isChecked}}', {
      inputType: 'checkbox',
      isChecked: true
    });
  ...
  ['@test static checkbox should begin disabled if the disabled attribute is true']() {
  ...
  ['@test static checkbox should support the tabindex property']() {
    this.render(staticCheckboxTemplate, staticCheckboxContext);
    equal(this.$('input').prop('tabindex'), '6', 'the initial checkbox tabindex is set in the DOM');
  ...
  ['@test static checkbox checkbox name is updated']() {
    this.render(staticCheckboxTemplate, staticCheckboxContext);
    equal(this.$('input').attr('name'), 'hello', 'renders checkbox with the name');
  ...
  ['@test static checkbox checkbox checked property is updated']() {
    this.render(staticCheckboxTemplate, staticCheckboxContext);
    equal(this.$('input').prop('checked'), false, 'the checkbox isn\'t checked yet');
  ...
  ['@test placeholder attribute bound to undefined is not present']() {
  ...
  ['@test placeholder attribute bound to null is not present']() {
    this.render('{{input placeholder=someThingNotThere}}', {
